"""
Make a a function that returns the sum of the first n natural numbers (exlusive).
...
def sum_first_n_nums(n: int) -> int:
    ...
    return _sum_first_n_nums_pythonic(n)
...
def _sum_first_n_nums_pythonic(n: int) -> int:
    """
    Pythonic solution.
    """
